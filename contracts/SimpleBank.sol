...
contract SimpleBank {
    ...
    modifier isEnrolled(address customer) {
        require(enrolled[msg.sender], 'user must be enrolled in the bank');
        _;
    }
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
        /* If the sender's balance is at least the amount they want to withdraw,
           ...
           require(balances[msg.sender] >= withdrawAmount, 'not enough ether in account');
